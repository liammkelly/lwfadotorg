...
function defHdrStyle() {
	...
	dvHdr.style.border='1px solid #62778F';
	dvHdr.style.padding='3';
	dvHdr.style.fontSize='10';
	dvHdr.style.color='#FFFFFF';
	dvHdr.style.background='#6699CC';
...
function defBdyStyle() {
	dvBdy.style.borderBottom='1px solid #62778F';
	dvBdy.style.borderLeft='1px solid #62778F';
	dvBdy.style.borderRight='1px solid #62778F';
